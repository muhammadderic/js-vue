...
<template >
  <section class="text-white" id="testimonials" data-aos="zoom-in">
      ...
      <Carousel v-bind="settings" :breakpoints="breakpoints" >
        <Slide v-for="element in testimonials" :key="element.id">
          <div class="carousel__item px-4">
            <div class="w-full mx-auto rounded-xl bg-[#111a3e] shadow-lg border border-[#1f1641] p-5 text-white font-light mb-6">
...
<style >
  ...
  .carousel__next {
    ...
    pointer-events: all; /* Re-enable clicks for the arrows */
  }
</style>